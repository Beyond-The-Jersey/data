...
RATINGS = [{'sponsorId': 'aarp',
 ...
 {'sponsorId': 'acrisure',
  ...
  'claim': {'text': 'Acrisure LLC is the ultimate owner of Acrisure.',
            ...
            'source': {'name': 'Inference based on company name and industry analysis',
                       'date': None,
 ...
 {'sponsorId': 'albert',
  ...
  'claim': {'text': 'Albert LLC is the ultimate owner of Albert.',
            ...
            'source': {'name': 'Inference based on company name and industry analysis',
                       'date': None,
                       'url': 'https://example.com'}},
  'verdict': 'Owned by Albert LLC. Nothing found.',
  'confidence': 'low',
  'note': 'Private Company company with no significant conduct issues found'},
 ...
 {'sponsorId': 'ball-corporation',
  ...
  'claim': {'text': 'Ball Corporation is the ultimate owner of Ball Corporation.',
            ...
            'source': {'name': 'Inference based on company name and industry analysis',
                       'date': None,
                       'url': 'https://example.com'}},
  'verdict': 'Owned by Ball Corporation. Nothing found.',
  'confidence': 'medium',
  'note': 'Listed Company company with no significant conduct issues found'},
 ...
 {'sponsorId': 'capital-one',
  ...
  'owner': {'id': 'capital-one-owner',
            ...
            'type': 'listed-company',
            'country': 'US',
            'note': 'Capital One has paid significant regulatory settlements including $425 million in 2023 for 360 '
                    'Savings interest-rate practices and $140 million in 2020 for CFPB credit card marketing '
                    'practices.'},
  ...
  'confidence': 'medium',
  'note': 'Capital One has paid significant regulatory settlements including $425 million in 2023 for 360 Savings '
          'interest-rate practices and $140 million in 2020 for CFPB credit card marketing practices.'},
 {'sponsorId': 'carvana',
  'tier': 'none',
  'ownership': 'owned',
 ...
 {'sponsorId': 'cleveland-cliffs',
  ...
  'claim': {'text': 'Cleveland-Cliffs LLC is the ultimate owner of Cleveland-Cliffs.',
            ...
            'source': {'name': 'Inference based on company name and industry analysis',
                       'date': None,
                       'url': 'https://example.com'}},
  'verdict': 'Owned by Cleveland-Cliffs LLC. Nothing found.',
  'confidence': 'low',
  'note': 'Private Company company with no significant conduct issues found'},
 ...
 {'sponsorId': 'delta-air-lines',
  ...
  'claim': {'text': 'Delta Air Lines LLC is the ultimate owner of Delta Air Lines.',
            ...
            'source': {'name': 'Inference based on company name and industry analysis',
                       'date': None,
                       'url': 'https://example.com'}},
  'verdict': 'Owned by Delta Air Lines LLC. Nothing found.',
  'confidence': 'low',
  'note': 'Private Company company with no significant conduct issues found'},
 ...
 {'sponsorId': 'empower',
  ...
  'claim': {'text': 'Empower LLC is the ultimate owner of Empower.',
            ...
            'source': {'name': 'Inference based on company name and industry analysis',
                       'date': None,
                       'url': 'https://example.com'}},
  'verdict': 'Owned by Empower LLC. Nothing found.',
  'confidence': 'low',
  'note': 'Private Company company with no significant conduct issues found'},
 ...
 {'sponsorId': 'fedex',
  ...
  'claim': {'text': 'FedEx LLC is the ultimate owner of FedEx.',
            ...
            'source': {'name': 'Inference based on company name and industry analysis',
                       'date': None,
                       'url': 'https://example.com'}},
  'verdict': 'Owned by FedEx LLC. Nothing found.',
  'confidence': 'low',
  'note': 'Private Company company with no significant conduct issues found'},
 ...
 {'sponsorId': 'foundation-building-materials',
  ...
  'claim': {'text': 'Foundation Building Materials (FBM) LLC is the ultimate owner of Foundation Building Materials '
            ...
            'source': {'name': 'Inference based on company name and industry analysis',
                       'date': None,
                       'url': 'https://example.com'}},
  'verdict': 'Owned by Foundation Building Materials (FBM) LLC. Nothing found.',
  'confidence': 'low',
  'note': 'Private Company company with no significant conduct issues found'},
 ...
 {'sponsorId': 'hard-rock-international',
  ...
  'claim': {'text': 'Hard Rock International LLC is the ultimate owner of Hard Rock International.',
            ...
            'source': {'name': 'Inference based on company name and industry analysis',
                       'date': None,
                       'url': 'https://example.com'}},
  'verdict': 'Owned by Hard Rock International LLC. Nothing found.',
  'confidence': 'low',
  'note': 'Private Company company with no significant conduct issues found'},
 ...
 {'sponsorId': 'jpmorgan-chase',
  ...
  'owner': {'id': 'jpmorgan-chase-chase-owner',
            ...
            'type': 'listed-company',
            'country': 'US',
            'note': 'JPMorgan Chase has paid multiple significant settlements including $151 million in 2024 for SEC '
                    'violations and various other regulatory matters.'},
  'claim': {'text': 'JPMorgan Chase & Co. is the ultimate owner of JPMorgan Chase (Chase).',
            'short': 'JPMorgan Chase & Co.',
            'source': {'name': 'JPMorgan Chase Investor Relations',
                       'date': None,
                       'url': 'https://www.jpmorganchase.com'}},
  'verdict': 'JPMorgan Chase & Co.',
  'confidence': 'medium',
  'note': 'JPMorgan Chase has paid multiple significant settlements including $151 million in 2024 for SEC '
          'violations and various other regulatory matters.'},
 ...
 {'sponsorId': 'pnc-bank',
  ...
  'owner': {'id': 'pnc-bank-pnc-financial-services-owner',
            ...
            'type': 'listed-company',
            'country': 'US',
            'note': 'PNC has paid significant settlements including $6.1 million in 2023 for BBVA 401(k) fees and '
                    'various mortgage-related settlements.'},
  'claim': {'text': 'PNC Financial Services Group, Inc. is the ultimate owner of PNC Bank (PNC Financial Services).',
            ...
            'source': {'name': 'PNC Financial Services Investor Relations',
                       'date': None,
                       'url': 'https://investor.pnc.com'}},
  'verdict': 'PNC Financial Services Group, Inc.',
  'confidence': 'medium',
  'note': 'PNC has paid significant settlements including $6.1 million in 2023 for BBVA 401(k) fees and various '
