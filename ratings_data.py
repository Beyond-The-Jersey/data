...
RATINGS = [{'sponsorId': 'aarp',
 ...
 {'sponsorId': 'acrisure',
  ...
  'claim': {'text': 'Acrisure, LLC is the ultimate owner of Acrisure.',
            ...
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Acrisure, LLC. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of pittsburgh-steelers (2026-27).'},
 {'sponsorId': 'adidas',
  'tier': 'concern',
 ...
 {'sponsorId': 'albert',
  ...
  'claim': {'text': 'Albert is the ultimate owner of Albert.',
            'short': 'Albert is the ultimate owner of Albert.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Albert. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of los-angeles-lakers (2026-27).'},
 ...
 {'sponsorId': 'amica-mutual-insurance',
  ...
  'verdict': 'Owned by Amica Mutual Insurance Company. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of boston-celtics (2026-27).'},
 {'sponsorId': 'arctempus',
  'tier': 'none',
 ...
 {'sponsorId': 'atlantic-health',
  ...
  'verdict': 'Owned by Atlantic Health System. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of new-york-jets (2026-27).'},
 {'sponsorId': 'atlassian',
  'tier': 'none',
 ...
 {'sponsorId': 'ball-corporation',
  ...
  'claim': {'text': 'Ball Corp is the ultimate owner of Ball Corporation.',
            'short': 'Ball Corp is the ultimate owner of Ball Corporation.',
            'source': {'name': 'Ball Corp SEC Filing',
                       'date': '2026-03-31',
                       'url': 'https://www.sec.gov/Archives/edgar/data/ballcorp/0000000000-00-000000.txt'}},
  'verdict': 'Owned by Ball Corp. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of denver-nuggets (2026-27).'},
 ...
 {'sponsorId': 'capital-one',
  ...
  'claim': {'text': 'Capital One Financial Corp. is the ultimate owner of Capital One.',
            ...
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Capital One Financial Corp.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of washington-wizards (2026-27).'},
 {'sponsorId': 'carvana',
  'tier': 'none',
 ...
 {'sponsorId': 'cleveland-cliffs',
  ...
  'claim': {'text': 'Cleveland Cliffs is the ultimate owner of Cleveland-Cliffs.',
            'short': 'Cleveland Cliffs is the ultimate owner of Cleveland-Cliffs.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Cleveland Cliffs. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of cleveland-cavaliers (2026-27).'},
 ...
 {'sponsorId': 'delta-air-lines',
  ...
  'claim': {'text': 'Delta Air Lines, Inc. is the ultimate owner of Delta Air Lines.',
            'short': 'Delta Air Lines, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Delta Air Lines, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of utah-jazz (2026-27).'},
 ...
 {'sponsorId': 'empower',
  ...
  'claim': {'text': 'Empower Retirement is the ultimate owner of Empower.',
            'short': 'Empower Retirement is the ultimate owner of Empower.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Empower Retirement. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of denver-broncos (2026-27).'},
 {'sponsorId': 'eni',
  'tier': 'serious',
 ...
 {'sponsorId': 'fedex',
  ...
  'claim': {'text': 'Fedex is the ultimate owner of FedEx.',
            'short': 'Fedex is the ultimate owner of FedEx.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Fedex. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of memphis-grizzlies (2026-27).'},
 {'sponsorId': 'fiserv',
  'tier': 'none',
 ...
 {'sponsorId': 'foundation-building-materials',
  ...
  'claim': {'text': 'Foundation Building Materials, Inc. is the ultimate owner of Foundation Building Materials '
                    '(FBM).',
            'short': 'Foundation Building Materials, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Foundation Building Materials, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of los-angeles-angels (2026-27).'},
 ...
 {'sponsorId': 'gillette-procter-and-gamble',
  'tier': 'none',
  'ownership': 'owned',
  'owner': {'id': 'gillette-procter-and-gamble-owner',
            'name': 'The Procter & Gamble Company',
            'type': 'private-company',
            'country': 'US',
            'note': 'No state stake or serious conduct record identified. Ownership is private or listed with no '
                    'state involvement.'},
  'claim': {'text': 'The Procter & Gamble Company is owned by The Procter & Gamble Company. No state shareholder '
                    'identified. Ownership sits with public institutional and retail investors, so the sponsorship '
                    'money is purely private capital.',
            'short': 'The Procter & Gamble Company is owned by The Procter & Gamble Company.',
            'source': {'name': 'PROCTER & GAMBLE Co DEF 14A 2026 (SEC)',
                       'date': '2026-08-28',
                       'url': 'https://www.sec.gov/Archives/edgar/data/80424/000119312526372211/pg-20260826.htm'}},
  'verdict': 'Owned by The Procter & Gamble Company. Nothing found.',
  'confidence': 'medium',
  'note': 'No state stake or serious conduct record identified. Ownership is private or listed with no state '
          'involvement.'},
 {'sponsorId': 'globe-life-globe-life-inc',
  ...
  'claim': {'text': 'Globe Life Globe Life Inc is the ultimate owner of Globe Life (Globe Life Inc.).',
            ...
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Globe Life Globe Life Inc. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of texas-rangers (2026-27).'},
 {'sponsorId': 'google',
  'tier': 'none',
 ...
 {'sponsorId': 'hard-rock-international',
  ...
  'claim': {'text': 'Hard Rock International is the ultimate owner of Hard Rock International.',
            'short': 'Hard Rock International is the ultimate owner of Hard Rock International.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Hard Rock International. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of miami-dolphins (2026-27).'},
 {'sponsorId': 'herbalife',
  'tier': 'concern',
 ...
 {'sponsorId': 'ibotta',
  ...
  'claim': {'text': 'Ibotta, Inc. is the ultimate owner of Ibotta.',
            'short': 'Ibotta, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Ibotta, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of denver-nuggets (2026-27).'},
 {'sponsorId': 'ifs',
  'tier': 'concern',
 ...
 {'sponsorId': 'jpmorgan-chase-chase',
  ...
  'claim': {'text': 'JPMorgan Chase & Co. is the ultimate owner of JPMorgan Chase (Chase).',
            'short': 'JPMorgan Chase & Co.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by JPMorgan Chase & Co.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of arizona-diamondbacks (2026-27).'},
 ...
 {'sponsorId': 'kia-america',
  ...
  'verdict': 'Owned by Kia America. Nothing found.',
  'confidence': 'high',
  'note': "Kia's largest shareholder is Hyundai Motor Company (~35.17%), a private conglomerate; no state ownership "
          'in Kia or its parent. No documented human-rights concerns in ownership chain identified.'},
 ...
 {'sponsorId': 'ledger',
  ...
  'claim': {'text': 'Ledger SAS is the ultimate owner of Ledger.',
            'short': 'Ledger SAS is the ultimate owner of Ledger.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Ledger SAS. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of san-antonio-spurs (2026-27).'},
 {'sponsorId': 'lenovo',
  'tier': 'concern',
 ...
 {'sponsorId': 'loandepot',
  ...
  'claim': {'text': 'loanDepot, Inc. is the ultimate owner of loanDepot.',
            'short': 'loanDepot, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by loanDepot, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of miami-marlins (2026-27).'},
 {'sponsorId': 'lucas-oil',
  'tier': 'none',
 ...
 {'sponsorId': 'lumen-technologies',
  ...
  'claim': {'text': 'Lumen Technologies, Inc. is the ultimate owner of Lumen Technologies.',
            'short': 'Lumen Technologies, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Lumen Technologies, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of seattle-seahawks (2026-27).'},
 ...
 {'sponsorId': 'metlife',
  ...
  'claim': {'text': 'MetLife, Inc. is the ultimate owner of MetLife.',
            'short': 'MetLife, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by MetLife, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of new-york-jets (2026-27).'},
 {'sponsorId': 'microsoft',
  'tier': 'none',
 ...
 {'sponsorId': 'motorola',
  ...
  'claim': {'text': 'Motorola Solutions, Inc. is the ultimate owner of Motorola.',
            'short': 'Motorola Solutions, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Motorola Solutions, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of san-diego-padres (2026-27).'},
 {'sponsorId': 'mrq',
  'tier': 'none',
 ...
 {'sponsorId': 'nintendo',
  ...
  'claim': {'text': 'Nintendo Co., Ltd. is the ultimate owner of Nintendo (Nintendo of America).',
            'short': 'Nintendo Co., Ltd.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Nintendo Co., Ltd.. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of seattle-mariners (2026-27).'},
 ...
 {'sponsorId': 'nrg-energy-reliant-brand',
  ...
  'claim': {'text': 'NRG Energy, Inc. is the ultimate owner of NRG Energy (Reliant brand).',
            'short': 'NRG Energy, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by NRG Energy, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of houston-texans (2026-27).'},
 {'sponsorId': 'oracle',
  'tier': 'none',
 ...
 {'sponsorId': 'paypal',
  ...
  'claim': {'text': 'PayPal Holdings, Inc. is the ultimate owner of PayPal.',
            'short': 'PayPal Holdings, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by PayPal Holdings, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of phoenix-suns (2026-27).'},
 ...
 {'sponsorId': 'pnc-bank-pnc-financial-services',
  ...
  'claim': {'text': 'PNC Financial Services Group, Inc. is the ultimate owner of PNC Bank (PNC Financial Services).',
            'short': 'PNC Financial Services Group, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by PNC Financial Services Group, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of pittsburgh-pirates (2026-27).'},
 ...
 {'sponsorId': 'quiktrip',
  ...
  'claim': {'text': 'QuikTrip Corporation is the ultimate owner of QuikTrip.',
            'short': 'QuikTrip Corporation is the ultimate owner of QuikTrip.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by QuikTrip Corporation. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of kansas-city-royals (2026-27).'},
 {'sponsorId': 'raisin',
  'tier': 'none',
 ...
 {'sponsorId': 'rocket-rocket-companies',
  ...
  'claim': {'text': 'Rocket Companies, Inc. is the ultimate owner of Rocket (Rocket Companies).',
            'short': 'Rocket Companies, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Rocket Companies, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of cleveland-cavaliers (2026-27).'},
 ...
 {'sponsorId': 'securian-financial',
  ...
  'claim': {'text': 'Securian Financial Group, Inc. is the ultimate owner of Securian Financial.',
            'short': 'Securian Financial Group, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Securian Financial Group, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of minnesota-twins (2026-27).'},
 ...
 {'sponsorId': 'sofi',
  ...
  'claim': {'text': 'SoFi Technologies, Inc. is the ultimate owner of SoFi.',
            'short': 'SoFi Technologies, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by SoFi Technologies, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of los-angeles-chargers (2026-27).'},
 {'sponsorId': 'spotify',
  'tier': 'none',
 ...
 {'sponsorId': 'stifel',
  ...
  'claim': {'text': 'Stifel Financial Corp. is the ultimate owner of Stifel Financial.',
            'short': 'Stifel Financial Corp.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Stifel Financial Corp.. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of st-louis-cardinals (2026-27).'},
 {'sponsorId': 'sumup',
  'tier': 'none',
 ...
 {'sponsorId': 't-mobile',
  ...
  'claim': {'text': 'T-Mobile US, Inc. is the ultimate owner of T-Mobile.',
            'short': 'T-Mobile US, Inc.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by T-Mobile US, Inc.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of seattle-mariners (2026-27).'},
 {'sponsorId': 'tag-heuer',
  'tier': 'none',
 ...
 {'sponsorId': 'target-target-corporation',
  'tier': 'none',
  'ownership': 'owned',
  'owner': {'id': 'target-target-corporation-owner',
            'name': 'Target (Target Corporation)',
            'type': 'listed-company',
            'country': 'USA',
            'note': 'Target is publicly traded with no state ownership; no 5%+ holder of note. No documented '
                    'human-rights concerns in ownership chain identified.'},
  'claim': {'text': 'Target Corporation is NYSE-listed (TGT) with a fully dispersed shareholder base and no state or '
                    'sovereign-fund owner.',
            'short': 'Target Corporation is NYSE-listed (TGT) with a fully dispersed shareholder base and no state '
                     'or sovereign-fund owner.',
            'source': {'name': 'Target Corporation Form 10-K FY2025',
                       'date': '2026-03-11',
                       'url': 'https://www.sec.gov/Archives/edgar/data/27419/000002741926000016/tgt-20260131.htm'}},
  'verdict': 'Owned by Target (Target Corporation). Nothing found.',
  'confidence': 'high',
  'note': 'Target is publicly traded with no state ownership; no 5%+ holder of note. No documented human-rights '
          'concerns in ownership chain identified.'},
 {'sponsorId': 'td-bank',
  'tier': 'none',
  'ownership': 'owned',
 ...
 {'sponsorId': 'toyota',
  ...
  'claim': {'text': 'Toyota Motor Corp. is the ultimate owner of Toyota.',
            'short': 'Toyota Motor Corp.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Toyota Motor Corp.. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of houston-rockets (2026-27).'},
 ...
 {'sponsorId': 'ucla-health',
  ...
  'claim': {'text': 'UCLA Health is the ultimate owner of UCLA Health.',
            'short': 'UCLA Health is the ultimate owner of UCLA Health.',
            'source': {'name': 'UCLA Health About Us', 'date': None, 'url': 'https://www.uclahealth.org/about-us/'}},
  'verdict': 'UCLA Health is the ultimate owner of UCLA Health.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of los-angeles-chargers (2026-27).'},
 {'sponsorId': 'unicredit',
  'tier': 'none',
 ...
 {'sponsorId': 'united-wholesale-mortgage',
  ...
  'claim': {'text': 'United Wholesale Mortgage LLC is the ultimate owner of United Wholesale Mortgage.',
            'short': 'United Wholesale Mortgage LLC is the ultimate owner of United Wholesale Mortgage.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by United Wholesale Mortgage LLC. Nothing found.',
  'confidence': 'medium',
  'note': 'Arena naming-rights holder of phoenix-suns (2026-27).'},
 {'sponsorId': 'uralkali',
  'tier': 'concern',
 ...
 {'sponsorId': 'webull',
  ...
  'claim': {'text': 'Webull Corp. is the ultimate owner of Webull.',
            'short': 'Webull Corp.',
            'source': {'name': 'Unknown', 'date': None, 'url': 'https://example.com'}},
  'verdict': 'Owned by Webull Corp.. Nothing found.',
  'confidence': 'medium',
  'note': 'Jersey patch partner of tampa-bay-rays (2026-27).'},
 {'sponsorId': 'wwk',
  'tier': 'none',
